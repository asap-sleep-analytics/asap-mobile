...
export default function TipsHomeScreen({
  navigation,
}: {
  navigation: {
    ...
    <AmbientBackdrop>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.subtitle}>
          Guía práctica y fuentes en español, con foco en reducir el riesgo de
        ...
        {TIPS_MODULES.map((module) => (
          <Pressable
            key={module.id}
            onPress={() =>
              navigation.navigate("TipsDetail", { moduleId: module.id })
            }
          >
            {({ pressed }) => (
              <GlassCard
                style={[styles.moduleCard, pressed ? styles.pressed : null]}
              >
                <View style={styles.moduleTopRow}>
                  <Text style={[styles.moduleAccent, { color: module.accent }]}>
                    Módulo
                  </Text>
        ...
        <GlassCard style={styles.helperCard}>
          ...
          <View style={styles.helperRows}>
            <Text style={styles.helperBullet}>
              1. Elige un módulo según tu situación actual.
            </Text>
            <Text style={styles.helperBullet}>
              2. Marca acciones completadas en el checklist.
            </Text>
            <Text style={styles.helperBullet}>
              3. Revisa fuentes oficiales para ampliar información.
            </Text>
          </View>
        </GlassCard>
      </ScrollView>
