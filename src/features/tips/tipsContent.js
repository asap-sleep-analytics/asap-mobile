export const TIPS_MODULES = [
  ...
  },
  {
    ...
    checklist: [
      "Reconocí mis síntomas principales",
      "Hablé con mi familia sobre pausas respiratorias",
      "Planifiqué consulta médica",
    ],
    resources: [
      {
  ...
  },
  {
    ...
    checklist: [
      "Cené más liviano",
      "Mantuve hora de despertar constante",
      "Reduje ruido y luz en habitación",
    ],
    resources: [
      {
